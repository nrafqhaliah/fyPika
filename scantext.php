...
<head>
    <meta charset="utf-8">
    <title>Scan Ingredient | FridgeFriend</title>
            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Scan Your Ingredient Name</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">fridgefriend</h6>
                <h1 class="mb-5">Scanning...</h1>
            </div>
            ...
            <div class="row g-4">
                    ...
                    <div class="service-rounded">
                        ...
                        <input type="file" class='btn btn-primary rounded-pill py-2' id="imageInput">
                    <button class='btn btn-primary rounded-pill py-2' onclick="processImage()">Scan Image</button>
