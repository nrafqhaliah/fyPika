...
<head>
    <meta charset="utf-8">
    <title>Ingredient | FridgeFriend</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="ingredient.php" class="nav-item nav-link active">Ingredient</a>
                    <a href="recipe.php" class="nav-item nav-link">Recipe</a>     
            </div>
            <a href="logout.php" class="btn btn-primary rounded-pill py-2 px-4" style="background-color: burlywood;">Logout</a>
            </div>
        </nav>
            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Ingredient</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                                <li class="breadcrumb-item text-white active" aria-current="page">Ingredient</li>
                            </ol>
                        </nav>
                    </div>
                </div>
