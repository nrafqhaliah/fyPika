...
<head>
    <meta charset="utf-8">
    <title>Login | FridgeFriend</title>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="img/bg3.jpg" alt="" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">Fridgefriend</h6>
                    <h1 class="mb-4">Login <span class="text-primary">Account</span></h1>
                           ...
                           <?php
                            ...
                            if(isset($_POST['username'], $_POST['password'])){
                                ...
                                if(is_array($row) && !empty($row)){
                                    ...
                                    echo "<a href='login.php'><button class='btn-primary rounded-pill py-2 px-4 btn-custom'>Go Back</button>";
                                }
                                ...
                                echo "<div class='message'>
                                       <br> <p>Login Successfully!</p>
                                        </div>";
                                    echo "<a href='index.php'><button class='btn-primary rounded-pill py-2 px-4 btn-custom'>Home Page</button>";
                                }
                            ...
                            <form method="post" action="login.php" >
                                ...
                                <div class="d-grid gap-2">
                                    <!-- Button -->
                                    <input type="submit" href="index.php" class="btn btn-primary rounded-pill py-2 px-4 btn-custom" value="Login" ></input>
                                </div><br>Don't have account?
